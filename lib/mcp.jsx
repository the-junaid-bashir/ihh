        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="max-w-md text-gray-400 leading-relaxed border-l-2 border-white/10 pl-6">
              A resilient, tamper-proof mcp registry built for the next agentic  web. 
              ...
              <div className="p-6 space-y-4">
                <div className="space-y-2">
                  <div className="flex gap-4">
                    ...
                    <code className="text-sm">ihub op clone @mcpservername</code>
                  </div>
