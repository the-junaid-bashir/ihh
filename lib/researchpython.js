...
export default async function ResearchPython(task) {
    ...
    const chatCompletion = await groq.chat.completions.create({
            messages: [
                ...
                Your goal: Research the latest stable python  packages and best implementation patterns for the user's task.
