...
const FEATURES = [
  { label: 'Publish', val: 'ipm op publishclaw <name>' },
  { label: 'Install', val: 'ipm op installclaw <name>' },
  { label: 'Behavior', val: 'Deterministic' },
  { label: 'Versioned', val: 'Fully reproducible' },
  { label: 'Workspace', val: 'skills.md / heartbeat.md / tools.md' },
];

const ImmutableAgentsHero = () => {
  return (
    <div
      style={{
        position: 'relative',
      ...
      >
        ...
        <div>
          ...
          >
            Immutable
            <br />
            <span style={{ color: 'rgba(255,255,255,0.4)' }}>Agents</span>
          </h1>
          ...
          >
            OpenClaw agents, packaged into IPM — workspace, skills, heartbeat and agent
            definition included. Install once, run forever.
          </p>
        ...
        <div>
          <div style={{ ...glass, borderRadius: 26, overflow: 'hidden' }}>
            ...
            >
              ...
              >
                <Terminal size={12} /> immutable_agent.pkg
              </span>
            </div>
...
export default ImmutableAgentsHero;