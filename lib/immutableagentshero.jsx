...
import { Cpu, Package, ShieldCheck, Terminal, GitBranch, ArrowRight } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="max-w-md text-gray-400 leading-relaxed border-l-2 border-white/10 pl-6">
              OpenClaw agents — packaged into IPM.  
              Workspace included. Skills. Heartbeat. Agent definition.  
